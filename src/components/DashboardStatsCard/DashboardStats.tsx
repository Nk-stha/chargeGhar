...
import { FiDollarSign, FiUsers, FiAlertCircle, FiCheckCircle } from 'react-icons/fi';
  ...
  if (loading) {
    return (
      <>
        ...
        <StatsCard icon={<FiCheckCircle />} title="Stations Active" value="Loading..." />;
      </>
    );
  }
  ...
  if (error) {
    return (
      <>
        ...
        <StatsCard icon={<FiCheckCircle />} title="Stations Active" value="Error" />;
      </>
    );
  }
